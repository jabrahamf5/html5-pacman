...
function Pacman(config) {
	...
	// Pacman image
	var img = new Image();
	img.src = config.image; if(img.src === null) { img.src = "pacman-right.gif"; }
	...
	var changeDirection = function(dir) {
		...
		switch(direction) {
			case DIRECTIONS.up:
				img.src = "pacman-up.gif";
			break;
			case DIRECTIONS.right:
				img.src = "pacman-right.gif";
			break;
			case DIRECTIONS.bottom:
				img.src = "pacman-bottom.gif";
			break;
			case DIRECTIONS.left:
				img.src = "pacman-left.gif";
			break;
		}
...
var pacman = new Pacman({grid:grid, image:'pacman-left.gif'});
